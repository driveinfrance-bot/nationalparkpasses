    ...
    <div className="section">
      <div className="container grid gap-8 md:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-3">
          ...
          <h1 className="text-4xl font-semibold">Apply in 3 steps</h1>
          <p className="text-slate-600">
            We collect only what’s required: vehicle details, your email, and
            your registration document. Payment is secured by Stripe.
          </p>
