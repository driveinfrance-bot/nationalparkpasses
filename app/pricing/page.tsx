      ...
      <div className="container grid gap-8 md:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-4">
          ...
          <div className="card p-6">
            ...
            <a className="button mt-5 w-full justify-center" href="/apply">
              Start application
            </a>
          </div>
        </div>
        <div className="card space-y-4 p-6">
          ...
          <div className="rounded-xl bg-slate-50 p-4 text-sm text-slate-700">
            <p className="font-semibold text-slate-900">Official disclosure</p>
            <p className="mt-1">
              This is a private application assistance service and not
              affiliated with the French government. The official fee is
