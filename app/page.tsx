            ...
            <div className="card w-full p-6">
              ...
              <div className="mt-6 rounded-xl bg-slate-50 p-4 text-sm text-slate-700">
                ...
                <p>
                  ...
                  affiliated with the French government.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container grid items-center gap-8 md:grid-cols-2">
          ...
          <div className="card space-y-4 p-6 text-sm text-slate-700">
            ...
            <div>
              ...
              <p className="mt-1">
                No. We are a private processing service and not affiliated with
                the French government. The official fee is included in our
                transparent price.
              </p>
            </div>
          </div>
      ...
      <section className="section bg-white">
        <div className="container grid items-center gap-6 md:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="grid grid-2 gap-4">
            {[
              "Where Crit’Air is required in 2025",
